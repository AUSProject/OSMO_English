...
namespace SHJ
{
    class PEPrinter
    {
        ...
        private void TransDetail()
        {
            ...
            {
                case 0x6000:
                    PEPrinterStatedetail = "initializing";
                    break;
                case 0x0000:
                    PEPrinterStatedetail = "Ready";
                    break;
                case 0x0001:
                    PEPrinterStatedetail = "button operation test";
                    break;
                case 0x0002:
                    PEPrinterStatedetail = "Test actions for functional checks";
                    break;
                case 0x1000:
                    PEPrinterStatedetail = "sleep state";
                    break;
                case 0x2000:
                    PEPrinterStatedetail = "Set the digital potentiometer";
                    break;
                case 0x4000:
                    PEPrinterStatedetail = "The print head is cooling down";
                    break;
                case 0x4001:
                    PEPrinterStatedetail = "Wait for the print head to cool";
                    break;
                case 0x6400:
                    PEPrinterStatedetail = "pallet loading";
                    break;
                case 0x6500:
                    PEPrinterStatedetail = "Tray is popping up";
                    break;
                case 0x6800:
                    PEPrinterStatedetail = "printing";
                    break;
                case 0x7FFD:
                    PEPrinterStatedetail = "I/F command is being executed";
                    break;
                case 0x7FFE:
                    PEPrinterStatedetail = "Writing to FlashROM";
                    break;
                case 0x7FFF:
                    PEPrinterStatedetail = "busy";
                    break;
                case 0x8100:
                    PEPrinterStatedetail = "Top cover is open";
                    break;
                case 0x8800:
                    PEPrinterStatedetail = "An illegal media adapter is configured or not set";
                    break;
                case 0x8A00:
                    PEPrinterStatedetail = "medium anomaly";
                    break;
                case 0x8AFF:
                    PEPrinterStatedetail = "Seal not set";
                    break;
                case 0x9100:
                    PEPrinterStatedetail = "Abnormal print head";
                    break;
                case 0x9101:
                ...
                case 0x9120:
                    ...
                    break;
                case 0x9200:
                    PEPrinterStatedetail = "Tray Assembly Abnormal";
                    break;
                case 0x9201:
                ...
                case 0x9291:
                    ...
                    break;
                case 0x92A1:
                    PEPrinterStatedetail = "During pallet eject operation, the pulse number of pallet encoder 1 is 0";
                    break;
                case 0x92B1:
                    PEPrinterStatedetail = "托盘移动到媒介适配器的检查位置时，托盘编码器1的脉冲数为0";
                    break;
                case 0x92C1:
                    PEPrinterStatedetail = "When the tray moves to the printing start position, the pulse number of tray encoder 1 is 0";
                    break;
                case 0x92C3:
                    PEPrinterStatedetail = "During printing operation, the pulse number of tray encoder 1 is 0";
                    break;
                case 0xA100:
                ...
                case 0xC101:
                    ...
                    break;
                case 0xD100:
                    PEPrinterStatedetail = "print head error";
                    break;
                case 0xD101:
                    PEPrinterStatedetail = "print head overheating";
                    break;
                case 0xD102:
                    PEPrinterStatedetail = "Printhead low temperature failure, or no printhead installed";
                    break;
                case 0x8300:
                ...
                case 0x8400:
                    ...
                    break;
                case 0x8700:
                    PEPrinterStatedetail = "The stop key is pressed to enter the emergency stop state";
                    break;
                case 0x9400:
                    PEPrinterStatedetail = "Push mechanism failure";
                    break;
                case 0x9401:
                ...
                case 0x9402:
                    ...
                    break;
                case 0x9600:
                    PEPrinterStatedetail = "F/W update failure";
                    break;
                case 0x9601:
                    PEPrinterStatedetail = "在向ROM传输F/W更新文件时，USB电缆被拔出";
                    break;
                case 0xE000:
                    PEPrinterStatedetail = "Fatal error in F/W update";
                    break;
                case 0xE001:
                    PEPrinterStatedetail = "Built-in ROM checksum error";
                    break;
                case 0xE100:
                    PEPrinterStatedetail = "Fatal error on power up";
                    break;
                case 0xE101:
                    PEPrinterStatedetail = "Built-in ROM checksum error";
                    break;
                case 0xE102:
                    PEPrinterStatedetail = "Built-in Flash checksum error";
                    break;
                case 0xE103:
                    PEPrinterStatedetail = "Built-in SRAM check error";
                    break;
                case 0xE104:
                    PEPrinterStatedetail = "External SDRAM checksum error";
                    break;
                case 0xE200:
                    PEPrinterStatedetail = "Critical errors in normal operation";
                    break;
                case 0xE201:
                    PEPrinterStatedetail = "When writing the adjustment parameters, the ROM cannot be written normally";
                    break;
                case 0xE211:
                    PEPrinterStatedetail = "Tray motor drive chip overheating";
                    break;
                case 0xFFFF:
                    PEPrinterStatedetail = "not connected";
                    break;
            }
        }
        ...
        public void PEloop()
        {
            ...
            if (isconnected)
            {
                ...
                else if (needQueryPrinterInfo)//需要查询打印机信息
                {
                    ...
                    PEloopstate = "Query printer information";
                }
                else if (needGetPrinterInfoData)//需要获取打印机信息数据
                {
                    ...
                    PEloopstate = "Get printer information data";
                }
                else if (needPutPrintCondition)//需要发送打印配置命令
                {
                    ...
                    PEloopstate = "Send print configuration";
                }
                else if (needPutPrintConditionData)//需要发送打印配置数据
                {
                    ...
                    PEloopstate = "Send print configuration data";
                }
                else if (needQueryPrintCondition)//需要查询打印配置
                {
                    ...
                    PEloopstate = "Query print configuration";
                }
                else if (needGetPrintConditionData)//需要获取打印配置数据
                {
                    ...
                    PEloopstate = "Get print configuration data";
                }
                ...
                else if (needPutImage)//需要发送图片
                {
                    ...
                    PEloopstate = "send image command";
                }
                ...
                else if (needMoveToOrigin)//需要托盘定位
                {
                    ...
                    PEloopstate = "Pallet positioning";
                }
                else
                {
